...
- **Підписники** — динаміка приросту за обраний **діапазон дат** (пресети або свій період) + маркери виходу рілсів.
- **Сторіз** — аналітика за будь-який **діапазон дат** (пресети 7/30/60/90 днів або свій період): охоплення, взаємодії, репости, частка від усього контенту + тренд (агреговані дані з акаунт-аналітики).
